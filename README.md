# Hi there, I'm Hassan Baragbah 👋

An **Artificial Intelligence & Data Science Engineer** expanding into low-level systems and software engineering. I specialize in developing machine learning models, deep learning architectures (LSTM, Transfer Learning), and end-to-end data pipelines, with a strong foundation in low-level development.
...
`TensorFlow` `PyTorch` `Keras` `Scikit-learn` `Pandas` `NumPy` `Feature Engineering`

**Data Visualization & Tools:**
`Power BI` `Tableau` `Matplotlib` `Seaborn` `Jupyter Notebook` `Flask` `Git` `GitHub`
...
<p align="center">
  <img src="https://github-readme-stats-fast.vercel.app/api?username=HassanMBaragbah&show_icons=true&theme=tokyonight" height="165" />
  &nbsp;
  <img src="https://github-readme-stats-fast.vercel.app/api/top-langs/?username=HassanMBaragbah&layout=compact&theme=tokyonight" height="165" />
</p>
